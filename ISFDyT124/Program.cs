...
builder.Services.AddAuthentication("Cookies") // Define el esquema de autenticaci�n llamado "Cookies" 
    .AddCookie("Cookies", options => // Configura opciones para autenticaci�n por cookies 
    {
